# -*- coding: utf-8 -*-
"""
Created on Tue Oct 17 22:44:33 2023
...
#To perform clustering and KMeans for AutoInsurance.
...
univ
univ.iloc[:,2:8].groupby(univ.Policy).mean()
univ.to_csv("c:\Datasets\AutoInsurance.csv",encoding='utf-8')
